Assignment 2 Question 4 simulates a multithreaded client server architecture that emulates clients sending print requests to multiple printers.
...
helps control the flow of the code by ensuring that elements are only inserted or removed when list can accomodate it (ie insert when the list is not full
